              ...
              {paginatedTransactions.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-slate-500 dark:text-slate-400">
                  <div className="w-16 h-16 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-4">
                    <Icons.CreditCard size={32} className="text-slate-300 dark:text-slate-600" />
                  </div>
                ...
                <div className="space-y-4">
                  {paginatedTransactions.map((txn) => (
                    ...
                    >
                      {/* Top Row - Avatar, User, Amount */}
                      <div className="flex items-center gap-3 p-4">
                        {/* User Avatar */}
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900/40 dark:to-emerald-800/20 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="px-4 py-2 bg-slate-50 dark:bg-slate-800/50 flex items-center gap-3">
                        <Badge
                          variant={getStatusVariant(txn.status) as "success" | "warning" | "danger" | "info" | "neutral"}
